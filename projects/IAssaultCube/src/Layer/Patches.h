...
private:
	std::vector<GamePatch>(patches) = {
		...
		GamePatch{ "No Recoil",						0x62274, { 0x0F, 0xBF, 0x8F, 0x22, 0x01, 0x00, 0x00 }, { 0x31, 0xC9, 0x90, 0x90, 0x90, 0x90, 0x90 }, 7 },
		GamePatch{ "No Kickback (Primary)",			0x63dd5, { 0x0F, 0xBF, 0x88, 0x16, 0x01, 0x00, 0x00 }, { 0x31, 0xc9, 0x90, 0x90, 0x90, 0x90, 0x90 }, 7 },
		GamePatch{ "No Kickback (Secondary)",		0x625a4, { 0x0F, 0xBF, 0x88, 0x16, 0x01, 0x00, 0x00 }, { 0x31, 0xc9, 0x90, 0x90, 0x90, 0x90, 0x90 }, 7 },
		GamePatch{ "No Spread",						0x620B8, { 0x0F, 0x8E, 0x88, 0x00, 0x00, 0x00 }, { 0xE9, 0x89, 0x00, 0x00, 0x00, 0x90 }, 6 },
		GamePatch{ "Unlimited Ammo",				0x637e9, { 0xFF, 0x0E }, { 0x90, 0x90 }, 2 },
		GamePatch{ "Ignore Magazine Validation",	0x6368e, { 0x75, 0x71 }, { 0xEB, 0x71 }, 2 },
		GamePatch{ "Unlimited Grenades",			0x63378, { 0xFF, 0x08 }, { 0x90, 0x90 }, 2 },
		GamePatch{ "No Grenade throw delay",		0x63370, { 0xE8, 0x2B, 0xC2, 0xFF, 0xFF }, { 0x90, 0x90, 0x90, 0x90, 0x90 }, 5 },
	};
};
